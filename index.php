            ...
            <div class="card-body">
                <div class="card-deck">
                    ...
                    <div class="card" id="card">
                        <a href="#">
                            <img class="card-img-top" id="product" src="images/products/rnd.webp" alt="Card image cap">
                        </a>
                        <div class="card-body">
                    ...
                    <div class="card" id="card">
                        <a href="class.php">
                            <img class="card-img-top" id="product" src="images/products/bag.webp" alt="Card image cap">
                        </a>
                        <div class="card-body">
